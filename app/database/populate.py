...
def seed_database():
    """
    Cleans the database and populates it with realistic IT product data and users.
    ...
    with app.app_context():
        ...
        for _ in range(NUM_RECORDS):
            user = Utilisateur(
                ...
                mot_de_passe=generate_password_hash("blent"),  # default test password
        ...
        # Custom dictionary to ensure names like "ASUS NVIDIA RTX 4080" instead of generic text
        DATA_INFO = {
        ...
        for _ in range(NUM_RECORDS):
            ...
            prod = Produit(
                ...
                description=f"Description aléatoire: {fake.paragraph(nb_sentences=3)}",
                categorie=cat_info,
        ...
        # Flush ensures IDs are generated by the DB before we create related records
        db.session.flush()
